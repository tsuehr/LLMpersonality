...
def eval_model(model=None,instruction=None,item=None,answers=None,options=None,meta_instruction = None,p_answers=None,p_options =None,persona =None,coagulator=None ,i_negated=None, context_history=None, answer_seed_counts = None):
    ...
    if context_history == "":
        answer_seed = np.argmin(answer_seed_counts)
        log = options[answer_seed]
                    ...
                    for coagulator,coagulator_name in cond_coagulator:
                        for p_answer,p_answer_name in cond_p_answers:
                            for p_option,p_option_name in cond_p_options:
                                answer_seed_counts = [0,0,0,0,0]
                                for persona in cond_persona:
                                    answer_seed_counts[np.argmin(answer_seed_counts)] +=1
                                    counter = counter+1
                                        ...
                                        for aspect_name in aspect_names:
                                            ...
                                            for reverse_key in [0,1]:
                                                for item in aspects[test_name][aspect_name][reverse_key]:
                                                    ...
                                                    answer_seed_counts = answer_seed_counts,
                                    ...
                                    pd.DataFrame(result_list).to_csv("output_raw/incontext/"+args.model_name+"_"+args.conditions+"_"+args.test+"_seeded.csv") #Save results once a persona-condition is fully evaluated. 
